(function($) {
  $.extend(true, $.summernote.lang, {
    'hr-HR': {      countchars: {
      ...
      tableHeader: {
        toggle: 'Uključi/isključi zaglavlje tablice',
      },
      strongEm: {
      ...
      link: {
        ...
        emailBody: 'Poruka',
        telNumber: 'Broj telefona',
        telInvalid: 'Unesite valjani broj telefona (6–15 znamenki)',
      },
      table: {
        table: 'Tablica',
      ...
      'insertBreak': 'Umetni prijelom retka',
