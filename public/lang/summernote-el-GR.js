  ...
  $.extend(true, $.summernote.lang, {
    'el-GR': {      countchars: {
      ...
      link: {
        ...
        emailSubject: 'Θέμα',
        emailBody: 'Μήνυμα',
        telNumber: 'Αριθμός τηλεφώνου',
        telInvalid: 'Εισάγετε έναν έγκυρο αριθμό τηλεφώνου (6–15 ψηφία)',
      },
      video: {
        video: 'Βίντεο',
      ...
      table: {
        ...
        rowColor: 'Χρώμα γραμμής',
        colColor: 'Χρώμα στήλης',
        mergeCol: 'Ανάπτυξη στήλης',
        splitCol: 'Συρρίκνωση στήλης',
        mergeRow: 'Ανάπτυξη γραμμής',
        splitRow: 'Συρρίκνωση γραμμής',
      },
      hr: {
      ...
      'insertBreak': 'Εισαγωγή αλλαγής γραμμής',
