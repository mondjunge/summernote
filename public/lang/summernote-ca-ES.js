  ...
  $.extend(true, $.summernote.lang, {
    'ca-ES': {      countchars: {
      ...
      link: {
        ...
        emailBody: 'Missatge',
        telNumber: 'Número de telèfon',
        telInvalid: 'Introduïu un número de telèfon vàlid (6-15 dígits)',
      },
      table: {
        table: 'Taula',
