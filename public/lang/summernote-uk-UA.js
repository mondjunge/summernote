  ...
  $.extend(true, $.summernote.lang, {
    'uk-UA': {      countchars: {
      ...
      link: {
        ...
        telNumber: 'Номер телефону',
        telInvalid: 'Введіть дійсний номер телефону (6–15 цифр)',
      },
      table: {
        table: 'Таблиця',
        ...
        cellColor: 'Колір комірки',
        rowColor: 'Колір рядка',
        colColor: 'Колір стовпця',
        mergeCol: 'Розширити стовпець'єднати стовпці (colspan +1)',
        splitCol: 'Звузити стовпець',
        mergeRow: 'Розширити рядок',
        splitRow: 'Звузити рядок',
      },
      hr: {
      ...
      'insertBreak': 'Вставити перенос рядка',
