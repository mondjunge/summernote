  ...
  $.extend(true, $.summernote.lang, {
    'bg-BG': {      countchars: {
      ...
      link: {
        ...
        emailSubject: 'Тема',
        emailBody: 'Съобщение',
        telNumber: 'Телефонен номер',
        telInvalid: 'Моля, въведете валиден телефонен номер (6–15 цифри)',
      },
      table: {
        table: 'Таблица',
